...
const dummyData = {
  1: {
    ...
    financials: {
      quarters: ['22(1~4Q)', '23(1~4Q)', '24(1~4Q)', '25(1~3Q)'],
      revenue: [1100, 1150, 1200, 1350],
      opProfit: [40, 45, 50, 80],
      netIncome: [20, 25, 30, 60]
    },
    peers: [
      {
        id: 101,
    ...
    deepMetrics: {
      growth: {
        ...
        data: {
          revGrowth: { target: [10, 12, 15], avg: [9, 9, 10], peers: { 101: [10, 11, 12], 102: [25, 28, 30], 103: [4, 5, 5] } },
          niGrowth: { target: [0, 2, 5], avg: [7, 8, 8], peers: { 101: [9, 9, 10], 102: [-15, -12, -10], 103: [1, 2, 2] } },
          assetGrowth: { target: [6, 7, 8], avg: [5, 5, 5], peers: { 101: [6, 6, 7], 102: [22, 21, 20], 103: [3, 3, 3] } }
        }
      },
      profit: {
        label: '수익성',
        ...
        data: {
          gpm: { target: [38, 39, 40], avg: [34, 34, 35], peers: { 101: [37, 37, 38], 102: [15, 18, 20], 103: [30, 30, 30] } },
          opm: { target: [8, 9, 10], avg: [7, 7, 8], peers: { 101: [14, 14, 15], 102: [-8, -6, -5], 103: [5, 5, 5] } },
          roe: { target: [3, 4, 5], avg: [5, 5, 6], peers: { 101: [9, 9, 10], 102: [-20, -18, -15], 103: [3, 3, 3] } }
        }
      },
      stability: {
        label: '안정성',
        ...
        data: {
          debtRatio: { target: [130, 125, 120], avg: [100, 100, 100], peers: { 101: [95, 92, 90], 102: [220, 210, 200], 103: [50, 50, 50] } },
          intCov: { target: [2, 2.5, 3], avg: [5, 5, 5], peers: { 101: [7, 7, 8], 102: [0.2, 0.4, 0.5], 103: [10, 10, 10] } },
          capRatio: { target: [35, 38, 40], avg: [50, 50, 50], peers: { 101: [58, 59, 60], 102: [15, 18, 20], 103: [70, 70, 70] } }
        }
      }
    },
    valuation: {
